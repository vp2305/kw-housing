...
function Home() {
  ...
  const handleSubmit = (e) => {
    ...
    if (
      ...
      emailjs.send("service_6bg1s07", "template_dmd5sg7", templateParams).then(
        (response) => {
          ...
          <div className="home__subtitle">
            ...
            <div className="buttonContainer">
              <Button
                variant="contained"
                type="primary"
                onClick={() => history.push("/browse-listing")}
              >
                Browse Listings
              </Button>
              <Button
      ...
      <div className="features__container">
        <div className="features">
          <div className="features__wrapper">
            ...
            <p>
              Search with ease according to the: price, start term, location and
              more!
            </p>
          </div>
          <div className="features__wrapper">
            ...
            <p>
              Post your listing with our existing template in a matter of
              seconds!
            </p>
          </div>
          <div className="features__wrapper">
      ...
      <div className="contact-us__container">
        <div className="contact-us__wrapper">
          <div className="contact-us">
            ...
            <hr id="line-break" />
            <p>
              Have a question for us? Fill out our contact form and we will get
